...
import { Copy, Download, Share2, X, ChevronDown } from 'lucide-react'
                    ...
                    >
                        ...
                        >
                            <div className={cn(
                                ...
                                <div
                                    className={cn(
                                        ...
                                        isMobile ? "w-[300px] w-full h-full px-[1rem] py-[3rem] aspect-[3/4]" : "w-[600px] p-12 aspect-[3/4]"
                                    )}
                                    style={{
                                ...
                                >
                                    <div className={cn(
                                        "card  rounded-2xl flex flex-col justify-between text-white relative backdrop-blur-md bg-white/10 shadow-[0_30px_80px_-15px_rgba(0,0,0,0.7)]",
                                        isMobile ? "p-6 h-[calc(100vh-300px)]" : "p-12 h-full"
                                    )}>
                            ...
                            <div className={cn(
                                ...
                                isMobile ? "fixed bottom-0 left-0 right-0 h-auto" : "w-[450px] h-[90vh] overflow-y-auto"
                            )}>
                                ...
                                <div className={cn(
                                    ...
                                    isMobile ? "flex gap-3 overflow-x-auto h-auto" : "grid grid-cols-2 gap-2 h-[calc(80vh-120px)]"
                                )}>
                                ...
                                <div className={cn(
                                    isMobile
                                        ...
                                        : "p-3 grid grid-cols-2 gap-4 max-h-[250px]  custom-scrollbar"
                                )}>
